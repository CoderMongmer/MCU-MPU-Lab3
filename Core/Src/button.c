...
void getKeyInput(){
    for(int i = 0; i < NUM_BUTTONS; i++){
        ...
        switch(i){
            case 0:
                KeyReg0[i] = HAL_GPIO_ReadPin(BTN_0_GPIO_Port, BTN_0_Pin);
                break;
            case 1:
                KeyReg0[i] = HAL_GPIO_ReadPin(BTN_1_GPIO_Port, BTN_1_Pin);
                break;
            case 2:
                KeyReg0[i] = HAL_GPIO_ReadPin(BTN_2_GPIO_Port, BTN_2_Pin);
                break;
        }
